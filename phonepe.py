...
def top_chart_transaction_amount(table_name):
    ...
    col1,col2=st.columns(2)
    with col1:
        fig_amount_1=px.bar(df1, x='states',y='transaction_amount',title= 'TOP 10 OF TRANSACTION AMOUNT',hover_name='states',
                        color_discrete_sequence=px.colors.sequential.Aggrnyl, height =650 , width =600)
    ...
    fig_amount_3=px.bar(df2, y='states',x='transaction_amount',title= 'AVERAGE OF TRANSACTION AMOUNT',hover_name='states',orientation='h',
...
def top_chart_transaction_count(table_name):
    ...
    col1,col2=st.columns(2)
    with col1:
        fig_amount_1=px.bar(df1, x='states',y='transaction_count',title= 'TOP 10 OF TRANSACTION COUNT',hover_name='states',
                        color_discrete_sequence=px.colors.sequential.Aggrnyl, height =650 , width =600)
        st.plotly_chart(fig_amount_1)
    ...
    with col2:
        fig_amount_2=px.bar(df2, x='states',y='transaction_count',title= 'LAST 10 OF TRANSACTION COUNT',hover_name='states',
                        color_discrete_sequence=px.colors.sequential.Aggrnyl_r, height =650 , width =600)
        st.plotly_chart(fig_amount_2)
    ...
    df2=pd.DataFrame(table_3,columns=('states','transaction_count'))

    fig_amount_3=px.bar(df2, y='states',x='transaction_count',title= 'AVERAGE OF TRANSACTION COUNT',hover_name='states',orientation='h',
                    color_discrete_sequence=px.colors.sequential.Bluered_r, height =650 , width =600)
    st.plotly_chart(fig_amount_3)
...
def top_chart_registered_user(table_name,state):
    ...
    fig_amount_3=px.bar(df3,y='districts',x='regsiteredusers',title= 'AVERAGE  OF REGISTERED USER',hover_name='districts',orientation='h', 
                       color_discrete_sequence=px.colors.sequential.Bluered_r, height =800 , width =1000)
    st.plotly_chart(fig_amount_3)
...
def top_chart_registered_user(table_name):
    ...
    df1=pd.DataFrame(table_1,columns=('states','registeredusers'))


    col1,col2=st.columns(2)
    with col1:
        fig_amount_1=px.bar(df1, x='states',y='registeredusers',title= 'TOP 10 OF REGSITERED USER',hover_name='states',   
                        color_discrete_sequence=px.colors.sequential.Aggrnyl, height =650 , width =600)
        st.plotly_chart(fig_amount_1)
    ...
    with col2:
        fig_amount_2=px.bar(df2,x='states',y='registeredusers',title= 'LAST 10 OF REGSITERED USER',hover_name='states',   
                        color_discrete_sequence=px.colors.sequential.Aggrnyl_r, height =650 , width =600)
        st.plotly_chart(fig_amount_2)
    ...
    fig_amount_3=px.bar(df3,y='states',x='registeredusers',title= 'AVERAGE  OF REGISTERED USER',hover_name='states',orientation='h', 
                       color_discrete_sequence=px.colors.sequential.Bluered_r, height =800 , width =1000)
    st.plotly_chart(fig_amount_3)
...
st.title('PHONEPE DATA VISAULIZATION AND EXPLORATION')

with st.sidebar:

    select=option_menu('Main_Menu',['HOME','DATA EXPLORATION','TOP CHARTS'])
    ...
    with tab2:
        ...
        if method=='Map Insurance':
            ...
            with col1:
                ...
                years = st.slider('Select The Year', Map_Insurance['Years'].min(), Map_Insurance['Years'].max(), Map_Insurance['Years'].min(), key='unique_slider_key')
            ...
            with col1:
                ...
                years = st.slider('Select The Year_mu', Map_user['Years'].min(), Map_user['Years'].max(), Map_user['Years'].min(), key='unique_slider_key')
    ...
    with tab3:
        ...
        if method=='Top Insurance':
            ...
            with col1:
                ...
                years = st.slider('Select The Year_ti', Top_Insurance['Years'].min(), Top_Insurance['Years'].max())
            ...
            with col1:
                ...
                years = st.slider('Select The Year_tt', Top_Transaction['Years'].min(), Top_Transaction['Years'].max())
            ...
            with col1:
                ...
                years = st.slider('Select The Year_tu', Top_User['Years'].min(), Top_User['Years'].max())
